            ...
            <div>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input id="previous_name" type="text" name="previous_name" value="{{ old('previous_name') }}"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-1">
                    ...
                    <div class="grid gap-6 md:grid-cols-2" x-show="hasPermission" x-transition>
                        ...
                        <div>
                            ...
                            <input id="license_date" type="text" name="license_date" value="{{ old('license_date') }}"
            ...
            <div class="mt-2">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-1">
                    ...
                    <div>
                        ...
                        <input type="text" name="activity_field" id="activity_field" value="{{ old('activity_field') }}"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div>
                        <label for="researchTypes"
                               class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">نوع تحقیقات:</label>
                        <div x-data="{
            ...
            percentages: @json(old('percentages', []))
                            ...
                            <div class="flex items-center">
                                <input
                                    ...
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <label for="researchTypes"
                                       class="text-sm font-medium text-gray-900 dark:text-white mr-2">توسعه ای</label>
                                <input
                                    x-transition
                                    type="number"
                    ...
                    <div>
                        <label for="active_assistants"
                               class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">معاونت‌های فعال واحد
                            پژوهشی:</label>
                        <div x-data="{
            ...
            otherActiveAssistants: '{{ old('otherActiveAssistants', '') }}'
                            ...
                            <div class="flex items-center">
                                <input
                                    ...
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <label for="research" class="text-sm font-medium text-gray-900 dark:text-white mr-2">
                                    پژوهش
                                </label>
                            </div>
                            ...
                            <div class="flex items-center">
                                <input
                                    ...
                                    x-model="activeAssistants"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <label for="education" class="text-sm font-medium text-gray-900 dark:text-white mr-2">
                                    آموزش
                                </label>
                            </div>
                            ...
                            <div class="flex items-center">
                                <input
                                    ...
                                    x-model="activeAssistants"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <label for="cultural" class="text-sm font-medium text-gray-900 dark:text-white mr-2">
                                    فرهنگی
                                </label>
                            </div>
                    ...
                    otherPublicationStatus: '{{ old('otherPublicationStatus', '') }}'
                            ...
                            <div class="flex items-center">
                                <input
                                    ...
                                    id="promotional"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <label for="promotional" class="text-sm font-medium text-gray-900 dark:text-white mr-2">
                                    ترویجی
                                </label>
                            </div>
                            <div class="flex items-center">
                                <input
                                    ...
                                    id="specialized"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <label for="specialized" class="text-sm font-medium text-gray-900 dark:text-white mr-2">
                                    تخصصی
                                </label>
                            </div>
                            <div class="flex items-center">
                ...
                'همایش علمی': '{{ old('otherPublicationsAvailable')['همایش علمی'] ?? '' }}'
                            ...
                            <div class="flex items-center">
                                <input
                                    ...
                                    x-model="researchActivitiesOutput"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <label for="conference" class="text-sm font-medium text-gray-900 dark:text-white mr-2">
                                    همایش علمی
                                </label>
                                <input
                                    x-transition
                    ...
                    <div x-data="{ inputs: [''] }" class="space-y-4">
                        <label for="research_institute"
                               class="block text-sm font-medium text-gray-900 dark:text-white">پژوهشکده‌های فعال (نام
                            پژوهشکده‌ها):</label>
                    ...
                    <div x-data="{ inputs: [''] }" class="space-y-4">
                        <label for="research_group"
                               class="block text-sm font-medium text-gray-900 dark:text-white">گروه‌های پژوهشی فعال (نام
                            گروه‌ها):</label>
                        ...
                        <div x-data="{
                            ...
                            <div class="flex items-center">
                                <input
                                    ...
                                    id="fullTime"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <label for="fullTime" class="text-sm font-medium text-gray-900 dark:text-white mr-2">تمام
                                    وقت</label>
                                <input
                                    x-transition
                                    type="number"
                            ...
                            <div class="flex items-center">
                                <input
                                    ...
                                    id="partTime"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <label for="partTime" class="text-sm font-medium text-gray-900 dark:text-white mr-2">پاره
                                    وقت</label>
                                <input
                                    x-transition
                                    type="number"
                            ...
                            <div class="flex items-center">
                                <input
                                    ...
                                    id="projectBased"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <label for="projectBased" class="text-sm font-medium text-gray-900 dark:text-white mr-2">پروژه
                                    ای</label>
                                <input
                                    x-transition
                                    type="number"
                        ...
                        <div x-data="{
                            ...
                            <div class="flex items-center">
                                <input
                                    ...
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <label for="otherFinancialResource" class="text-sm font-medium text-gray-900 dark:text-white mr-2">
                                    سایر
                                </label>
                                <input
                                    x-transition
